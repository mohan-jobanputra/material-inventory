...
define('UL_DOMAIN', 'billing.app');

// Set to the path of the "ulogin" directory containing the source files.
// Do not use a trailing slash.
define('UL_INC_DIR', 'C:/xampp/htdocs/billing.app/php/ulogin/ulogin');
...
define('UL_SITE_KEY', 'doPo6TEx+ZSKWcc3elFQRp0K0IhMMkMM2vZUGbCjj2hdGNbJ3i8hAJYi');
...
define('UL_SITE_ROOT_DIR', 'C:/xampp/htdocs/billing.app');
